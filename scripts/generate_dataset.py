...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--height", type=int, default=256, help="Object and sensor height in pixels.")
    parser.add_argument("--width", type=int, default=256, help="Object and sensor width in pixels.")
    parser.add_argument("--pixel-pitch", type=float, default=4.65e-6, help="Pixel pitch in meters.")
    parser.add_argument("--wavelength", type=float, default=532e-9, help="Illumination wavelength in meters.")
    parser.add_argument("--distance", type=float, default=0.02, help="Propagation distance in meters.")
    parser.add_argument(
        "--carrier-x",
        type=float,
        default=1600.0,
    ...
    parser.add_argument("--no-preview", action="store_true", help="Disable PNG preview generation.")
...
def build_config(args: argparse.Namespace) -> HolographyConfig:
    ...
    optics = OpticalConfig(wavelength=args.wavelength, propagation_distance=args.distance)
...
def main() -> None:
    ...
    samples = list(generator.generate(count=args.samples, config=config, rng=rng))
